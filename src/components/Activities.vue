...
<template>
  <section id="activities" class="pt-24 md:pt-30 pb-24 flex flex-col px-4">
    <!-- Header -->
    <div class="mb-6">
    ...
    <div class="rounded-2xl bg-blur p-8" >
        ...
        <div <div v-for="item in filtered" :key="item.title" class="flex flex-col md:flex-row gap-4 mt-8 md:gap-8">
            <!-- year -->
            ...
            <div class="flex-1 flex-col gap-4">
                <!-- card -->
                <div
                  class="rounded-3xl bg-blur mb-4 p-6 hover:border-purple-500 transition" 
