...
const socialLinks = [
  { name: 'GitHub',    url: 'https://github.com/Chanakanit',                 icon: 'bg-icon-github-dark dark:bg-icon-github-light' },
  { name: 'Instagram', url: 'https://www.instagram.com/b.bigo.o/',           icon: 'bg-icon-instagram-dark dark:bg-icon-instagram-light' },
  { name: 'Facebook',  url: 'https://web.facebook.com/chanakan.unkhaow.2025', icon: 'bg-icon-face-dark dark:bg-icon-face-light' },
  { name: 'Email',     url: 'mailto:chanakanbbig@gmail.com',                 icon: 'bg-icon-email-dark dark:bg-icon-email-light' },
]
</script>
...
<template>
    ...
    >
        ...
        <div class="relative flex flex-col h-full justify-center flex-1 opacity-0 animate-delay-200 animate-fade-left">
            ...
            <h1 id="hero-heading" class="smooth-bg text-gradient-hero-name font-bold text-6xl animate-gradient">
                Chanakanit
            </h1>
            <p class="smooth-bg text-gradient-hero-title font-black mb-3 text-5xl animate-gradient" aria-label="Full Stack Developer">
                Full Stack Developer
            </p>
            <p class="smooth-bg text-lg text-slate-800 dark:text-slate-300">
            ...
            <div class="absolute bottom-22">
                ...
                <ul class="flex gap-3" aria-label="Social media links" role="list">
                    <li v-for="social in socialLinks" :key="social.name">
                        <a
                            ...
                            class="flex items-center justify-center bg-blur dark:bg-blur-blue icon-blur-accent w-13 h-13"
                        >
                            <span
        ...
        <div
            ...
            aria-hidden="true"
        >
            <span class="material-symbols-outlined smooth-bg animate-bounce
